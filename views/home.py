...
st.write("Diese App wurde von Yakin Boumaiza (boumayak@students.zhaw.ch),Teodora Marinkovic (marinte@students.zhaw.ch), Nicole (merolnic@students.zhaw.ch) im Rahmen des Moduls 'BMLD Informatik 2' an der ZHAW entwickelt.")